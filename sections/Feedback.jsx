    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">AI Researcher & Founder</p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          "AGI House has been instrumental in our journey. Their unique blend of capital, community, and enterprise connections helped us scale our AI solution from concept to deployment at major corporations."
        </p>
      </motion.div>
